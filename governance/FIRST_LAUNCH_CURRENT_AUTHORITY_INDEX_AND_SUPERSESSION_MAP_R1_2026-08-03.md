...
3. `FIRST_LAUNCH_MULTI_ASSET_PARALLEL_REPLACEMENT_ARCHITECTURE_DECISION_R1_2026-08-03.md`
   - 当前多资产迁移、旧 ETH 保底、新系统边界和长期替代路线最高架构权威。

4. `FIRST_LAUNCH_INTRADAY_ENTRY_STRATEGY_PRE_BACKTEST_FREEZE_R5_2026-08-02.md`
   - 当前三 Setup 的策略机制、因果原则和研究父合同；其中仍为描述性或与第 1/2 项冲突的内容，以机器包为准。

5. `FIRST_LAUNCH_SESSION_MOMENTUM_BREAKOUT_SCANNER_LITE_R3_FINAL_PARAMETER_AND_DELIVERY_FREEZE_2026-08-01.md`
   - Scanner 的 Universe、Stage A/B、WATCH/SETUP_READY、流动性、排名和产品边界权威；Scanner 状态不得替代正式三 Setup 权威。

6. `STRATEGY_RESEARCH_DISCOVERY_AND_CONVERGENCE_PLAYBOOK_V5_2026-08-03.md`
   - 小批量、快速前向验证、证据驱动和防止无限开发循环的方法权威。

7. `FIRST_LAUNCH_SHADOW_FORWARD_VALIDATION_AND_RAPID_ITERATION_PLAN_R1_2026-08-03.md`
   - 上线前最小正确性门禁、上线后前向验证、T/S/R、Outcome、导出和多轮迭代流程权威。

8. `FIRST_LAUNCH_CURRENT_MASTER_TASK_REGISTER_AND_EXECUTION_ORDER_R2_2026-08-03.md`
...
10. 三 Setup R1/R1.1/R1.2、旧最小上线记录、Pre-Backtest R2/R3/R4、Scanner R1/R2、旧产品与工程计划：
