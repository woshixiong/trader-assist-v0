...
-> BOUNDED REAL-MARKET SHADOW_SOAK
-> SEPARATELY_AUTHORIZED FIRST_LIVE
```
...
```text
EXACT CANDIDATE
-> APPLICABLE_LOCAL_OR_SAFE_VALIDATION
-> DRAFT_PR
-> EXACT_HEAD_CI
-> INDEPENDENT_REVIEW
-> USER_MARK_READY_AUTHORITY
-> USER_MERGE_AUTHORITY
-> POST_MERGE_CI / LIVE_MAIN_VERIFICATION
```
