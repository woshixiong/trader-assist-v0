...
class OfficialRateLimitSourceV0(_RateLimitAuthorityModel):
    ...
    retrieved_at: StrictStr = Field(pattern=r"^2026-07-12T04:24:4[01]Z$")
    publication_or_last_updated_marker: StrictStr = Field(min_length=1, max_length=80)
    evidence_identity: StrictStr = Field(pattern=r"^html-sha256:[0-9a-f]{64}$")
    content_sha256: Sha256Hex
    content_length_bytes: StrictInt = Field(gt=0)
...
class OfficialRateLimitAuthorityV0(_RateLimitAuthorityModel):
    ...
    transition_eligible: Literal[False] = False
    live_transport_authorized: Literal[False] = False
    account_readonly_runtime_authorized: Literal[False] = False
    testnet_execution_authorized: Literal[False] = False
    mainnet_execution_authorized: Literal[False] = False
    flp1_implementation_authorized: Literal[False] = False
...
_SOURCE_SPECS: tuple[dict[str, object], ...] = (
    {
        ...
        "canonical_location": "https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/rate-limits-and-user-limits",
        "retrieved_at": "2026-07-12T04:24:40Z",
        ...
        "content_sha256": "fdaf15ab3ede2056f24673a579684457e6f2eb75bc6626b657c22f47a132895e",
        "content_length_bytes": 394080,
    },
    {
        "source_id": INFO_ENDPOINT_SOURCE_ID,
        "kind": "OFFICIAL_HYPERLIQUID_DOCUMENTATION",
        "title": "Info endpoint",
        "canonical_location": "https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint",
        ...
        "content_sha256": "db7daffd672132ab651de4398fa7ce47d4bf24797b92d983233f80e4c56ed760",
        "content_length_bytes": 1900967,
    },
)
        ...
        OfficialRateLimitSourceV0.model_validate(
            {
                **spec,
                "source_hash": _hash_material(
                    OFFICIAL_RATE_LIMIT_SOURCE_HASH_VERSION, spec
                ),
            }
        )
...
def official_rate_limit_facts() -> tuple[OfficialRateLimitFactV0, ...]:
    return tuple(
        OfficialRateLimitFactV0.model_validate(
            {
                **spec,
                "fact_hash": _hash_material(
                    OFFICIAL_RATE_LIMIT_FACT_HASH_VERSION, spec
                ),
            }
        )
...
def official_rate_limit_unknowns() -> tuple[OfficialRateLimitUnknownV0, ...]:
    return tuple(
        OfficialRateLimitUnknownV0.model_validate(spec) for spec in _UNKNOWN_SPECS
    )
