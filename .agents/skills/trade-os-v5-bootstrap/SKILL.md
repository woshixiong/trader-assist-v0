---
name: trade-os-v5-bootstrap
description: Bind a Trade OS task to the exact manifest-selected governance, package identity, base, route, runtime identity, and retained gates before semantic mutation.
---

# Trade OS V5 Bootstrap
...
4. For Codex, require the V5-B deterministic bootstrap/identity checks once the
   manifest marks them qualified. V5-A alone is not runtime qualification.
5. Required requested/actual primary identity mismatch fails closed.
